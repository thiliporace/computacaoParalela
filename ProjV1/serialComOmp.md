Criamos um novo codigo usando a biblioteca GMP.H, para oferecer maior precisao na hora de fazer o calculo do numero decimal do E e na hora de printar esse valor.<br>
